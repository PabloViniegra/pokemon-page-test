...
<template>
  <div class="flex items-center gap-3" :title="description">
    <span class="text-gray-500 text-xs font-bold w-20 text-right shrink-0 cursor-help">{{ name }}</span>
    ...
    <span class="text-gray-700 font-mono text-xs font-bold w-8">{{ value }}</span>
  </div>
</template>
