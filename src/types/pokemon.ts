...
export interface PokemonSpeciesInfo {
    ...
    form_descriptions: { description: string; language: { name: string; url: string } }[];
...
export type SortOption = 'id-asc' | 'id-desc' | 'name-asc' | 'name-desc' | 'height-asc' | 'height-desc' | 'weight-asc' | 'weight-desc';
