...
<template>
  <main class="min-h-screen bg-[#f8f8f8]">
    <!-- Header -->
    <header class="relative overflow-hidden" style="background: linear-gradient(135deg, #3b4cca 0%, #2a3693 50%, #1a2266 100%);">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 py-8">
        ...
        <h1 class="text-4xl md:text-5xl font-black tracking-tighter text-white" style="font-family: 'Fredoka', sans-serif; text-shadow: 3px 3px 0 rgba(0,0,0,0.2);">
          Team Builder
        </h1>
        <p class="text-white/80 text-lg max-w-xl font-medium mt-2" style="text-shadow: 1px 1px 0 rgba(0,0,0,0.2);">
      ...
      <section class="bg-white rounded-3xl border-2 border-gray-100 p-6">
        <div class="flex items-center justify-between mb-5">
          <h2 class="text-xl font-bold text-gray-900">
            Your Team
            <span class="text-sm font-semibold text-gray-400 ml-2">({{ teamStore.teamSize }}/6)</span>
          </h2>
          <button
