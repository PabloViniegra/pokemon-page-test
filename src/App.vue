...
<template>
  <div class="min-h-screen bg-[#f8f8f8] text-gray-900 relative overflow-x-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        >
          <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <path d="M12 2a10 10 0 0 1 10 10H12V2z" fill="currentColor" fill-opacity="0.2"/>
        ...
        <div class="flex items-center gap-1">
          <button
            ...
            :class="isHome ? 'bg-red-50 text-red-600' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50'"
          >
            Pokédex
          </button>
          <button
            ...
            class="px-4 py-2 rounded-xl text-sm font-bold transition-colors"
            :class="isTeamBuilder ? 'bg-blue-50 text-blue-600' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50'"
          >
            Team Builder
          </button>
        </div>
